  ...
  <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                ...
                                <a href="/admin.php?c=admin">用户管理</a>
                            </li>
                            <li class="active">
                ...
                <div>
                    <button id="button-add" type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                                ...
                                <table class="table table-bordered table-hover singcms-table">
                                    ...
                                    <tbody>
                                        <?php if(is_array($admins)): $i = 0; $__LIST__ = $admins;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td>
                                                    <span attr-status="<?php if( $vo[ 'status'] == 1 ): ?>0<?php else: ?>1<?php endif; ?>"
                                                        attr-id="<?php echo ($vo["admin_id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off"><?php echo (status($vo["status"])); ?></span>
                                                </td>
                                                <td>
                                                    <a href="javascript:void(0)" attr-id="<?php echo ($vo["admin_id"]); ?>" id="singcms-delete"
                                                        attr-a="admin" attr-message="删除">
